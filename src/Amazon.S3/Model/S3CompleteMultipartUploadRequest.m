...
-(NSURLRequest *)configureURLRequest
{
    ...
    [urlRequest setValue:[NSString stringWithFormat:@"%ld", [[urlRequest HTTPBody] length]] forHTTPHeaderField:kHttpHdrContentLength];
...
-(NSData *)requestBody
{
    ...
    {
        [xml appendFormat:@"<Part><PartNumber>%ld</PartNumber><ETag>%@</ETag></Part>", [partNumber integerValue], [parts objectForKey:partNumber]];
    }
